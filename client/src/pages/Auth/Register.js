...
//               </div>
//               <small className="text-muted">
//                 Password should be at least 6 characters and include at least one uppercase letter, one lowercase letter, and one digit.
//               </small>
//             </div>
//             <div className="form-group flex-half">
//               <label htmlFor="confirmPassword">
//                 <i className="bi bi-shield-lock"></i> Confirm Password
//               </label>
//               <input
//                 type="password"
//                 name="confirmPassword"
